...
// need to check the order nodes get added to the lists (add to head or tail
// of the list??)
...
ShortestPaths dijkstra(Graph g, Vertex v) {
	...
	ItemPQ new_pqnode;
	new_pqnode.key = src;
	new_pqnode.value = short_p->dist[src];
